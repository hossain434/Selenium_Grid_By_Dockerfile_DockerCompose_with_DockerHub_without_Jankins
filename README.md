...
#### Note that volume mapping in the docker-compose file is not working here. Not sure why not working.
...
4.Sample script: Please refer this script here: Get_actual_title_NoDocker.java
